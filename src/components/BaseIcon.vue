<script setup>
// Line icons (Lucide-style, 24×24, stroke). Add new ones to this map.
const icons = {
  ...
  plan: '<rect width="18" height="18" x="3" y="3" rx="1"/><path d="M3 10h7"/><path d="M10 3v11"/><path d="M14 21v-6h7"/><path d="M10 18v3"/>',
